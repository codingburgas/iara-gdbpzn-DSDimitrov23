...
REAL_RIVERS = [
    ...
    },
    {
        ...
        'latitude': 42.067,
        'longitude': 27.981,
        'fish': ['Кефал', 'Каракуда', 'Шаран'],
        'description': 'Крайморска река в Странджа с тихи долни участъци и разнообразни места около Синеморец.',
        'fish_rules': [
            {'name': 'Кефал', 'season': '01.06 - 14.04', 'note': 'Най-активен през топлите месеци.'},
            {'name': 'Каракуда', 'season': 'Целогодишно', 'note': 'При спазване на дневните норми.'},
            {'name': 'Шаран', 'season': '01.06 - 14.04', 'note': 'Забранен през пролетното размножаване.'}
        ...
        'facts': [
            'Велека преминава през Странджа и се влива в Черно море при Синеморец.',
            'Долното течение е спокойно и подходящо за риболов от брега.',
            'При устието има силно влияние от морето и променящи се условия.'
        ]
    },
    {
        'name': 'Река Ропотамо',
        ...
        'latitude': 42.318,
        'longitude': 27.748,
        'fish': ['Кефал', 'Каракуда', 'Платика'],
        'description': 'Живописна река южно от Бургас с бавно течение, крайречна растителност и защитени природни зони.',
        'fish_rules': [
            {'name': 'Кефал', 'season': '01.06 - 14.04', 'note': 'Проверявайте ограниченията в защитените участъци.'},
            {'name': 'Каракуда', 'season': 'Целогодишно', 'note': 'При спазване на дневните норми.'},
            {'name': 'Платика', 'season': '01.06 - 14.04', 'note': 'Забранена през пролетното размножаване.'}
        ],
        'facts': [
            'Ропотамо е известна с лимана си и гъстата крайречна растителност.',
            'Част от района попада в защитени територии, затова условията трябва да се проверяват предварително.',
            'Ниското течение е бавно и предлага спокойни риболовни места.'
        ]
    },
    {
        'name': 'Река Ахелой',
        ...
        'latitude': 42.648,
        'longitude': 27.643,
        'fish': ['Шаран', 'Каракуда', 'Кефал'],
        'description': 'Река в Бургаска област с достъпни участъци около Ахелой и Поморийското крайбрежие.',
        'fish_rules': [
            {'name': 'Шаран', 'season': '01.06 - 14.04', 'note': 'Забранен през пролетното размножаване.'},
            {'name': 'Каракуда', 'season': 'Целогодишно', 'note': 'При спазване на дневните норми.'},
            {'name': 'Кефал', 'season': '01.06 - 14.04', 'note': 'Най-подходящ в по-топла вода.'}
        ],
        'facts': [
            'Ахелой се влива в Черно море близо до едноименния град.',
            'По-ниските участъци са лесни за достигане от крайбрежните населени места.',
            'След валежи нивото и мътността могат да се променят бързо.'
        ]
    }
]
...
def seed_real_operational_data():
    ...
    for item in REAL_RIVERS:
        if not River.query.filter_by(name=item['name']).first():
